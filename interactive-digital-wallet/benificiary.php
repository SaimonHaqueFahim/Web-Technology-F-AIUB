...
<!--addproduct starts -->
	...
	<div class="center">
		...
		<form action=""  method="post" name="addcategoryForm" onsubmit="return isvalid()">
				...
				<span id="catpnErr" style="color : red;"><?php echo $catpnErr; ?></span>
				<br>
				<br>
				<input type="submit" name="add_benificiary" class="btn btn-success" value="Add Category" class="form-control">
